...
public class RecordCriteria {
	...
	private int numPerPage; //한페이지에 보여줄 레코드 수
	
	final private int NUM_PER_PAGE=10;
	...
	//case1)시작 레코드 번호 = 종료레코드번호 -한페이지에 보여줄 레코드 수 + 1
	//case2)시작레코드번호=(요청페이지-1) * 한페이지에 보여줄 레코드 수 + 1
