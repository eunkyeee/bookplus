...
<script>
	...
	rereply_str += '    <a class="rrreply badge badge-pill badge-light mr-3">등록</a>';
	rereply_str += '    <a class="rrclose badge badge-pill badge-light text-danger mr-1">취소</a>';
	rereply_str += '</div>';
	rereply_str += '</div>';
	...
	replyModify_str += '    <a class="rrmodify badge badge-pill badge-light text-danger mr-3">수정</a>';
				...
				success:function(result){		
					$.each(result.item,function(idx, rec){
						...
						if(rec.rindent == 0){
							...
							str += '  <div class="col-1">';
							str += '    <img src="${pageContext.request.contextPath }/resources/img/login.png"';
							...
							str += '    <a class="rereplyBtn badge badge-pill badge-light"><i>댓글</i></a>';
							str += '  </div>';															
						}else{
						...
						if(l_id == rec.rid){
							...
							str += '    <a class="replyDelBtn badge badge-pill badge-secondary text-white">삭제</a>';
							str += '  </div>';	
						}
						str += '</div>';	
						str += '</div>';	
	...
	<!-- 댓글작성 -->
	<div class="row">
   	<textarea class="form-control" id="rcontent" name="rcontent" rows="3"
  ...
  <div class="row justify-content-end my-1">
		...
		<div class="col-sm-1 px-0 m-1">
     	<button class="btn btn-sm btn-outline-secondary btn-block" id="replyBtn2">등록</button>
    </div>
  </div>
	
	<!-- 댓글목록 -->
	<div class="row">
		<div id="replyList" class="col m-0 p-0">
